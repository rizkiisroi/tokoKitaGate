...
public class TokoKitaGateKafkaResourceIT {
    ...
    @Autowired
    private TokoKitaGateKafkaProducer producer;

    @Autowired
    private TokoKitaGateKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        TokoKitaGateKafkaResource kafkaResource = new TokoKitaGateKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/toko-kita-gate-kafka/publish?message=test"))
